...
130 P=1:C=2:T1=0:V=0:F0=1:O(1)=21:O(2)=19:O(3)=99:O(4)=6:O(5)=32:O(6)=0:O(7)=38:O(8)=36:O(9)=0:O(10)=35:O(11)=99:O(12)=33:O(13)=34:O(14)=37:O(17)=20:M(14,4)=0:Z=0:PRINT".";
...
150 F0=1:F1=0:F2=0:F3=0:F4=0:F5=0:F6=0:F7=0:F8=0:F9=0:OF=0:BG=0:P3=1:T0=120
...
705 ON I GOTO 1345,1310,775,1370,840,1470,1440,845,1520,840,785,1400,1125,785,840,1125,840
710 GOTO 975
...
765 ON I GOTO 840,840,775,820,840,840,840,830,840,840,785,840,840,790,840,840
770 GOTO 975
...
3000 REM -----------------------------------------
3010 REM Combined broken lines
3999 END
